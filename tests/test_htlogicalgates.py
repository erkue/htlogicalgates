...
class TestTailorLogicalGate(unittest.TestCase):
    ...
    def test_tailor_multiple_logical_gates(self):
        ...
        self.assertEqual(Circuit(res["Gates"][0]["Circuit"]).two_qubit_gate_count(), 0)
        self.assertEqual(Circuit(res["Gates"][1]["Circuit"]).two_qubit_gate_count(), 4)
        self.assertEqual(Circuit(res["Gates"][121]["Circuit"]).two_qubit_gate_count(), 3)